...
export default class extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('modalidad', 255).notNullable().comment('Modalidad de la empresa a la que se le realiza el requerimiento');
      ...
      table.uuid('usuariocreacion_id').notNullable().comment('Identificador del usuario que crear el requerimiento');
